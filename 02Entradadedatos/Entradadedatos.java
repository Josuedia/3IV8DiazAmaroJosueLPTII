...
//tipo de dato
 String nombre;
    // instancia
    System.out.println("Por favor introduce tu nombre y numero de tarjeta de credito y debito");
    //sysrem: la clase, out:el objeto, print:el metodo
    
    //vamos a obtener el nombre del usuario
    nombre = System.console().readLine();
    System.out.println("Hola " + nombre +" bienvenido jaja");
    } 
}
